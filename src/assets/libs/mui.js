...
(function($) {
    ...
    //处理vue2 + mui 打包压缩时 不支持arguments.callee问题
    function cextend(prop) {
        var _super = this.prototype;
        initializing = true;
        var prototype = new this();
        initializing = false;
...
(function($, window, document) {
    ...
    //处理vue2 + mui 打包压缩时没有声明而报错问题
    var progress,openedActions,isOpened;
    var sliderActionLeft,sliderActionRight,buttonsLeft,buttonsRight,sliderDirection,sliderRequestAnimationFrame;
    var translateX,lastTranslateX,sliderActionLeftWidth,sliderActionRightWidth;
